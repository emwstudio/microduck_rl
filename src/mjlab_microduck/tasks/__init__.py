...
# Dance — beat-conditioned dancing on the spot (squat_bounce / weight_shift /
# head_bob), phase+tempo+move command riding the body_pose obs slot.
register_mjlab_task(
...
_BACKLASH_TASKS = (
    ...
    # Dance builds on the walk model → walk backlash twin.
